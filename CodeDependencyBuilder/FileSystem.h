 ...
 * ====================
 * ver 2.3 : 30 May 13
 * - added capability to return fully qualified file names from Directory::getFiles
 *   by setting returnFullyQualified parameter to true - false by default.
 * ver 2.2 : 23 Feb 13
...
namespace FileSystem
{
  ...
  public:
    ...
    static std::vector<std::string> getFiles(const std::string& path=".", const std::string& pattern="*.*", bool returnFullyQualified=false);
